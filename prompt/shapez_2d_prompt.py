...
"""
    ...
    {
        "type": "text",
        "text": f"If you perform {steps} operations on this shape, what will the resulting configuration look like?  The operations are: {target_action_str}. Please select the correct answer from the options below. The options are: "
    },
    {
        "type": "text",
        "text": "A: "
